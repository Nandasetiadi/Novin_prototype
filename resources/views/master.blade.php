        ...
        <div class="container-fluid">
            <div class="me-5">
                <a class="navbar-brand" href="{{route('dashboard')}}">
                    <img src="\assets\images\Novin Logo.png" alt="Logo" width="60" height="54" class="d-inline-block align-text-top">
                    <b class="fs-3"></b>
                </a>
            </div>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon">NOVIN</span>
            </button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-5 me-auto mb-2 mb-lg-0">
                    ...
                    @if((Auth::user()->role=='masteradmin' or Auth::user()->role=='admin' or Auth::user()->role=='petugas'))    
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/pembaca/tampil">Pembaca</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <li>
